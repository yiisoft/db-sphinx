...
namespace Yiisoft\Db\Sphinx\Gii\Model;
...
class Generator extends \Yiisoft\Yii\Gii\Generator
{
    ...
    public $indexName;
    public $modelClass;
    public $baseClass = \Yiisoft\Db\Sphinx\ActiveRecord::class;
     ...
     * @param \Yiisoft\Db\TableSchema $table the table schema
     ...
     * @param \Yiisoft\Db\Sphinx\IndexSchema $index the index schema
